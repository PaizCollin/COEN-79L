...
namespace coen79_lab2
{
    class statistician
    {
        public:
            ...
            void next(double r); //double input taken as the next number in the sequence
            void reset(); //clears the statistician
        ...
        private:
            double total; //sum of the numbers in the sequence
            int size; //number of numbers in the sequence
            double min; //lowest value number in the sequence
            double max; //highest value number in the sequence
