...
namespace coen79_lab8
{
    ...
    //clears all of the items in the deque and sets them to null
    template <class Item>
    ...
    //allocates memory for more blockpointers to make room in the deque on both ends
    template <class Item>
    ...
    //pops/removes the item at the front of the deque
    template <class Item>
    ...
    //pops/removes the item from the back of the deque
    template <class Item>
